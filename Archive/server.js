...
function getInterestLabel(interest) {
  const map = {
    easylearn: "EasyLearn™ (Education Management / LMS)",
    docsign: "DocSign™ (Enterprise Digital & e-Signature Suite)",
    eserp: "EsERP™ (Enterprise Resource Planning)",
    esmed: "EsMed™ / Nexiora (Hospital Management)",
          ...
          <div class="body-content">
            ...
            <div class="product-links">
              ...
              <div style="font-size: 13px; color: #38bdf8;">
                &bull; <strong>EasyLearn™</strong> — Unified Campus & Learning Operating System<br>
                &bull; <strong>DocSign™</strong> — Enterprise e-Signature &amp; Contract Automation<br>
                &bull; <strong>EsERP™</strong> — Intelligent Enterprise Resource Planning<br>
                &bull; <strong>EsMed™ (Nexiora)</strong> — Hospital & Clinical Information System
              </div>
            </div>
          </div>
